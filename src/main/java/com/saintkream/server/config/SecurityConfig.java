...
import com.saintkream.server.jwt.JwtRequestFilter;
...
public class SecurityConfig {
   ...
   // 서버에 들어는 모든 요청은 SecurityFilterChain 을 거친다.
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        // 특정 URL에 인증없이 허용
                        .requestMatchers("/api/admin/**","/members/register", "/members/login",
                                "/members/send-phone-auth","/members/verify-phone-auth", 
                                "/members/**","/api/salespost/salesinsert")
                        .permitAll()
                        // 나머지는 인증 필요
    ...
    CorsConfigurationSource corsConfigurationSource() {
        ...
        // 허용할 Origin 설정
        corsConfig.setAllowedOrigins(Arrays.asList("http://localhost:3039","http://localhost:3000","http://localhost:8080" ));
        // 허용할 http 메서드 설정
