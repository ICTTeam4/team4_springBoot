...
public class TransactionController {
    ...
    @PostMapping("/updateisfixed")
    public Map<String, String> updateIsFixed(@RequestBody Map<String, Object> request) {
        log.info("리시브 리퀘스트: " + request);
        Map<String, String> response = new HashMap<>();
        try {
            int pwr_id = (int) request.get("pwr_id");
            log.info("pwr_id: " + pwr_id);

            int result = transactionService.updateIsFixed(pwr_id);
